...
type Errors struct {
	Defualt      string `mapstructure:"default"`
...
func parseEnv(cfg *Config) error {
	os.Setenv("TOKEN", "5879442443:AAEdZK4XFje5E4EdeGzGgguVCUZ11wzHN9Q")
	os.Setenv("CONSUMER_KEY", "105076-4285981b0f21e008ceef0c4")
